...
![Dashboard Overview](../.gitbook/assets/delivery-01-overview.png)
...
* **Du** : Date de début
* **Au** : Date de fin
* Exemple : _10 févr. 2025 - 15 févr. 2025_
...
![Liste des tâches](../.gitbook/assets/delivery-02-tasks-list.png)

### Barre de filtres

En haut de la liste, trois éléments permettent de filtrer :

1. **Date** : Sélecteur de date (ex: _10 févr. 2025_)
2. **Itinéraire** : Filtre par tournée (ex: _Tous les itinéraires_)
...
* **Horaire** : Créneau horaire (ex: _07:00-12:00_)
...
![En camion](../.gitbook/assets/delivery-03-en-camion.png)
...
![En route](../.gitbook/assets/delivery-04-en-route.png)
...
![Détail livraison](../.gitbook/assets/delivery-05-detail.png)
...
![Produits à valider](../.gitbook/assets/delivery-09-produits.png)

Pour chaque produit :

* **Description** : Désignation et quantité (ex: _80 PC CAFE 100% ARABICA MOULU 250G_)
...
![Produits confirmés](../.gitbook/assets/delivery-10-produits-ok.png)
...
![Motif échec](../.gitbook/assets/delivery-11-motif-echec.png)
...
![Produit échec](../.gitbook/assets/delivery-12-produit-echec.png)
...
![Impossible de livrer](../.gitbook/assets/delivery-06-impossible.png)

2. Sélectionnez un motif dans la liste :

![Motifs disponibles](../.gitbook/assets/delivery-07-motifs.png)
...
![Retours produits](../.gitbook/assets/delivery-09-produits.png)
...
![Retour scanné](../.gitbook/assets/delivery-13-retour-scan.png)
...
![Pièces jointes](../.gitbook/assets/delivery-09-produits.png)
...
![Référence document](../.gitbook/assets/delivery-14-reference.png)

1. Remplissez le champ **"Saisir la référence du document..."**
2. Cliquez sur **Confirmer**

> **Note** : Ce champ peut être requis (_Requis_) selon la configuration.
...
![Zone signature](../.gitbook/assets/delivery-15-signature.png)

1. Cliquez sur la zone **Signature**
2. Une fenêtre modale s'ouvre :

![Modal signature](../.gitbook/assets/delivery-16-modal-signature.png)
...
![Signature OK](../.gitbook/assets/delivery-17-signature-terminee.png)
...
![Confirmer](../.gitbook/assets/delivery-18-confirmer.png)
...
![Liste avec livrés](../.gitbook/assets/delivery-19-liste-livre.png)
...
Les livraisons sont groupées par itinéraire (ex: **BRUXELLES**) avec éventuellement des notes comme _"Attention travaux E411 !!!"_.

### Documents multiples

Une livraison peut contenir plusieurs documents (ex: _Facture 25663, Note de credit 2623_). Vous pouvez cliquer sur chaque document pour afficher les détails des produits ou des colis contenus dans ce document.
